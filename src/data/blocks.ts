...
const RAW = {
  longRun: { label: "Sortie longue", disc: "course", place: "exterieur", needs: ["exterieur"], min: 60, max: 100, hard: false, stack: false },
  quality: { label: "Fractionné", disc: "course", place: "exterieur", needs: ["exterieur"], min: 45, max: 70, hard: true, stack: false },
  tempo: { label: "Sortie soutenue", disc: "course", place: "exterieur", needs: ["exterieur"], min: 45, max: 60, hard: true, stack: false, group: "courseDure" },
  brick: { label: "Enchaînement vélo-course", disc: "course", place: "exterieur", needs: ["exterieur", "veloRoute"], min: 75, max: 110, hard: true, stack: false },
  bikeLong: { label: "Vélo route long", disc: "velo", place: "exterieur", needs: ["veloRoute"], min: 75, max: 150, hard: false, stack: false },
  bikeGym: { label: "Vélo d'appartement, endurance", disc: "velo", place: "salle", needs: ["veloSalle"], min: 40, max: 75, hard: false, stack: true, group: "veloEnd" },
  bikeGymInt: { label: "Vélo d'appartement, intervalles", disc: "velo", place: "salle", needs: ["veloSalle"], min: 40, max: 60, hard: true, stack: true, group: "veloInt" },
  bikeHT: { label: "Home-trainer, endurance", disc: "velo", place: "maison", needs: ["homeTrainer"], min: 40, max: 75, hard: false, stack: true, group: "veloEnd" },
  bikeHTint: { label: "Home-trainer, intervalles", disc: "velo", place: "maison", needs: ["homeTrainer"], min: 40, max: 60, hard: true, stack: true, group: "veloInt" },
  swimTech: { label: "Natation technique", disc: "natation", place: "piscine", needs: ["piscine"], min: 40, max: 60, hard: false, stack: false },
  swimEnd: { label: "Natation endurance", disc: "natation", place: "piscine", needs: ["piscine"], min: 45, max: 75, hard: false, stack: false },
