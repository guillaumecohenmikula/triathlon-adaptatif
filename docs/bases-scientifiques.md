...
>
> **Statut au 2026-09-07 : les six points de la liste finale sont appliqués.**
...
4. ~~**Renfo avant endurance** quand les deux partagent un créneau.~~ Fait le 2026-09-07.
...
6. ~~**Différencier réellement les trois modes** sur les charges et les répétitions.~~ Fait le
   2026-09-07 : les répétitions des exercices principaux et secondaires changent selon le mode,
   les accessoires et le gainage restent identiques.
